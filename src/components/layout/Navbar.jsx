                        ...
                        {isProfileOpen && (
                            <div className="absolute right-0 mt-3 w-60 bg-[#FAF6F0] rounded-2xl border-2 border-[#90353D]/20 shadow-xl shadow-[#90353D]/10 py-2 animate-fade-in-down">
                                ...
                                <nav aria-label="User menu" className="py-1">
                                    <a href="#profile" className="flex items-center gap-3 px-4 py-3 text-sm text-[#4A3C35] hover:bg-[#90353D]/10 hover:text-[#3E2723] transition-all duration-300">
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                        </svg>
                                        View Profile
                                    </a>
                                    <a href="#settings" className="flex items-center gap-3 px-4 py-3 text-sm text-[#4A3C35] hover:bg-[#90353D]/10 hover:text-[#3E2723] transition-all duration-300">
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
